...
* Once the application is launched, we can see that the application is up and running on localhost, port 3000 and can be accessed using the URL - [http://localhost:3000/](http://localhost:3000) with the title as "My Reads".
